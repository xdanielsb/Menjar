...
class CharitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post charities_url, params: { charity: { adress: @charity.adress, description: @charity.description, name: @charity.name, phone: @charity.phone } }
    end
  ...
  test "should update charity" do
    patch charity_url(@charity), params: { charity: { adress: @charity.adress, description: @charity.description, name: @charity.name, phone: @charity.phone } }
