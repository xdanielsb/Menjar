...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { date: @donation.date, description: @donation.description, state: @donation.state } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { date: @donation.date, description: @donation.description, state: @donation.state } }
